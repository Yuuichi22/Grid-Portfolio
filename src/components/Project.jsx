...
export const Project = ({ img, desc,icons}) => {
    return (
            ...
            <div className="group relative w-[250px] h-[200px] perspective-1000">
                ...
                <div className="absolute w-full h-full flex flex-col gap-2 justify-center items-center  bg-gray-800 bg-opacity-80 text-white text-lg rounded-md opacity-0 transition-opacity duration-500 group-hover:opacity-100 p-2 ">
